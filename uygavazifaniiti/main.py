...
# Mahsulot qo'shish (admin/user uchun)
...
if __name__ == '__main__':
    ...
    if Product.select().count() == 0:
        print("Baza bo'sh, demo mahsulotlar yuklanmoqda...")
        ...
        print(f"{len(demo_products)} ta mahsulot muvaffaqiyatli qo'shildi!")
